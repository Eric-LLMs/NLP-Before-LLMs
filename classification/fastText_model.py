...
def _test():
    ...
    is_training=True
    dropout_keep_prob=1
    fastText_model= fastText(num_classes, learning_rate, batch_size, decay_steps, decay_rate,5,sequence_length,vocab_size,embed_size,is_training)
    with tf.Session() as sess:
        ...
        for i in range(100):
            ...
            loss,acc,predict,_=sess.run([fastText_model.loss_val,fastText_model.accuracy,fastText_model.predictions,fastText_model.train_op],
                                        feed_dict={fastText_model.sentence:input_x,fastText_model.labels:input_y})
